...
class StyleTreeConstructor:
    ...
    def build_tree(self, root, css_rules):
        ...
        # No output for TextNode because it's just string, not an HTML tag.
        children = [self.build_tree(child, css_rules) for child in root.children if isinstance(child, ElementNode)]
